#ifndef JULIAPOWER4FRACTALS_UI_H
#define JULIAPOWER4FRACTALS_UI_H
...
class Ui_JuliaPower4FractalParams : public Ui_Main
{
public:
...
namespace Ui {
    class JuliaPower4FractalParams: public Ui_JuliaPower4FractalParams{};
} // namespace Ui

QT_END_NAMESPACE

#endif // JULIAPOWER4FRACTALS_UI_H
