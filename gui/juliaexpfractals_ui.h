#ifndef JULIAEXPFRACTALS_UI_H
#define JULIAEXPFRACTALS_UI_H
...
class Ui_JuliaExpFractalParams : public Ui_Main
{
public:
...
namespace Ui {
    class JuliaExpFractalParams: public Ui_JuliaExpFractalParams{};
} // namespace Ui

QT_END_NAMESPACE

#endif // JULIAEXPFRACTALS_UI_H
