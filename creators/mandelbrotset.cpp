...
MandelbrotSet::MandelbrotSet(): m_xmin(0.0), m_xmax(0.0), m_ymin(0.0), m_ymax(0.0)
{
}
...
void MandelbrotSet::resizeDivergencyMatrix(long xres, long yres)
{
...
double MandelbrotSet::createMandelbrot()
{
