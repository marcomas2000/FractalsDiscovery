...
Uni1MinusSquare::Uni1MinusSquare()
{
}
...
double Uni1MinusSquare::bifur(long ix)
{
    long i = 0;
    double ret=0.0;
...
void Uni1MinusSquare::storeImage(const char * standardPath)
{
    ...
    fileNameXML += "Uni1MinusSquare.xml";
     
    std::ofstream specs;
    specs.open(fileNameXML.c_str());
    specs << "<fractal fractaltype=\"Uni1MinusSquare: cx(1-pow(x,2)) \">" << std::endl;
    ...
    fileNameIm += "Uni1MinusSquare.csv";
