...
double UniXCubed::bifur(long ix)
{
    long i = 0;
    double ret=0.0;
...
void UniXCubed::storeImage(const char * standardPath)
{
    ...
    fileNameXML += "UniXCubed.xml";
     
    std::ofstream specs;
    specs.open(fileNameXML.c_str());
    specs << "<fractal fractaltype=\"UniXCubed: c pow(x,3) (1- x)\">" << std::endl;
