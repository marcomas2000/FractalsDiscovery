...
double UniLyapLike::bifur(long ix)
{
    long i = 0;
    double ret=0.0;
...
void UniLyapLike::storeImage(const char * standardPath)
{
    ...
    fileNameXML += "UniLyapLike.xml";
     
    std::ofstream specs;
    specs.open(fileNameXML.c_str());
    specs << "<fractal fractaltype=\"UniLyapLike: cx(1-x)\">" << std::endl;
