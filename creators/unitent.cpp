...
void UniTent::storeImage(const char * standardPath)
{
    ...
    fileNameXML += "UniTent.xml";
     
    std::ofstream specs;
    specs.open(fileNameXML.c_str());
    specs << "<fractal fractaltype=\"UniTent: c(1-2|x-1/2|)\">" << std::endl;
