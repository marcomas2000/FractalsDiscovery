...
JuliaSet::JuliaSet(): m_xmin(0.0), m_xmax(0.0), m_ymin(0.0), m_ymax(0.0), m_image(0)
{
}
...
QImage * JuliaSet::getImage()
{
    return m_image;
}

QRgb JuliaSet::setColour(int ris)
{
    QRgb value;
