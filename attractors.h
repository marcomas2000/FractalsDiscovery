...
class Attractors : public FractImage
{
public:
    Attractors();
    virtual ~Attractors();
...
inline void Attractors::setXmin(double value)
{
    m_xmin = value;
}

inline void Attractors::setYmin(double value)
{
    m_ymin = value;
}

inline void Attractors::setXmax(double value)
{
    m_xmax = value;
}

inline void Attractors::setYmax(double value)
{
    m_ymax = value;
}
