...
AttractHenon::AttractHenon() : m_maxiter(0), m_lx(0.0), m_ly(0.0), m_divergenceFactor(3.0)
{
}

AttractHenon::~AttractHenon()
{
}

int AttractHenon::msetlevel(double x_pos, double y_pos)
{
...
QRgb AttractHenon::setColour(int level)
{
    QRgb value;
